...
impl Mem64 {
    ...
    pub fn read_from(&self, addr: u64) -> &[u8] {
        ...
        log::debug!("mem: read_from: 0x{:x?} = {:?}", self.build_addresses(addr, max_sz), r);
        r
    }
    ...
    pub fn read_bytes(&self, addr: u64, sz: usize) -> &[u8] {
        ...
        log::debug!("mem: read_bytes: 0x{:x?} = {:?}", self.build_addresses(addr, sz), r);
        r
    }
    ...
    pub fn read_byte(&self, addr: u64) -> u8 {
        ...
        log::debug!("mem: read_byte: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 1), r);
    ...
    pub fn read_word(&self, addr: u64) -> u16 {
        ...
        log::debug!("mem: read_word: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 2), r);
    ...
    pub fn read_dword(&self, addr: u64) -> u32 {
        ...
        log::debug!("mem: read_dword: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 4), r);
    ...
    pub fn read_qword(&self, addr: u64) -> u64 {
        ...
        log::debug!("mem: read_qword: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 8), r);
    ...
    pub fn write_byte(&mut self, addr: u64, value: u8) {
        ...
        log::debug!("mem: write_byte: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 1), value);
    }
    ...
    pub fn write_bytes(&mut self, addr: u64, bs: &[u8]) {
        ...
        log::debug!("mem: write_bytes: 0x{:x?} = {:?}", self.build_addresses(addr, bs.len()), bs);
    }
    ...
    pub fn write_word(&mut self, addr: u64, value: u16) {
        ...
        log::debug!("mem: write_word: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 2), value);
    }
    ...
    pub fn write_dword(&mut self, addr: u64, value: u32) {
        ...
        log::debug!("mem: write_dword: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 4), value);
    }
    ...
    pub fn write_qword(&mut self, addr: u64, value: u64) {
        ...
        log::debug!("mem: write_qword: 0x{:x?} = 0x{:x}", self.build_addresses(addr, 8), value);
    }
    ...
    pub fn write_string(&mut self, addr: u64, s: &str) {
        ...
        log::debug!("mem: write_string: 0x{:x?} = {:?}", self.build_addresses(addr, s.len() + 1), s);
    }
    ...
    pub fn write_wide_string(&mut self, addr: u64, s: &str) {
        ...
        log::debug!("mem: write_wide_string: 0x{:x?} = {:?}", self.build_addresses(addr, s.len() * 2 + 2), s);
    }
