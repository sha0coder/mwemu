...
pub mod get_user_default_l_c_i_d;
...
pub use get_a_c_p::GetACP;
pub use get_c_p_info::GetCPInfo;
...
pub use get_console_c_p::GetConsoleCP;
pub use get_console_mode::GetConsoleMode;
pub use get_console_output_c_p::GetConsoleOutputCP;
...
pub use get_user_default_l_c_i_d::GetUserDefaultLCID;
...
pub use l_str_cmp_i_w::LStrCmpIW;
pub use l_str_cmp_i::LStrCmpI;
