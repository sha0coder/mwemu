...
fn test_fidiv_m16int_basic() {
    ...
    emu.maps.write_word(DATA_ADDR + 8, (2) as i16 as u16);
...
fn test_fidiv_m16int_max() {
    ...
    emu.load_code_bytes(&code);
    emu.maps.write_f64(DATA_ADDR, 100000.0);
    emu.maps.write_word(DATA_ADDR + 8, (i16::MAX) as i16 as u16);

    emu.run(None).unwrap();
    assert_eq!(emu.maps.read_f64(0x3000).unwrap(), 100000.0 / i16::MAX as f64);
}
...
fn test_fidiv_m32int_negative() {
    ...
    emu.load_code_bytes(&code);
    emu.maps.write_f64(DATA_ADDR, -250.0);
...
fn test_fidiv_m32int_large_divisor() {
    ...
    emu.load_code_bytes(&code);
    emu.maps.write_f64(DATA_ADDR, 2000000.0);
...
fn test_fidiv_m32int_fractional() {
    ...
    emu.load_code_bytes(&code);
    emu.maps.write_f64(DATA_ADDR, 1.0);
    emu.maps.write_dword(DATA_ADDR + 8, (7) as i32 as u32);
...
fn test_fidiv_chain() {
    ...
    emu.maps.write_f64(DATA_ADDR, 1000.0);
    emu.maps.write_dword(DATA_ADDR + 8, (10) as i32 as u32);
    emu.maps.write_dword(DATA_ADDR + 12, (5) as i32 as u32);
    emu.maps.write_dword(DATA_ADDR + 16, (2) as i32 as u32);
