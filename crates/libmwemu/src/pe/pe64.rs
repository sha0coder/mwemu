...
use crate::emu;
use crate::pe::pe32::{
    DelayLoadDirectory, HintNameItem, ImageDataDirectory, ImageDosHeader,
    ImageFileHeader, ImageImportDescriptor, ImageNtHeaders,
...
impl ImageOptionalHeader64 {
    pub fn load(raw: &[u8], off: usize) -> ImageOptionalHeader64 {
        ...
        ImageOptionalHeader64 {
            ...
            size_of_heap_commit: read_u64_le!(raw, off + 96),
